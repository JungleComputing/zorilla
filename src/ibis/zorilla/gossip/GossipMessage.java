...
class GossipMessage implements Serializable {
    ...
    public GossipMessage(NodeInfo sender, NodeInfo receiver,
            List<GossipCacheEntry> entries, boolean twoWay, String algorithmName) {
        this.sender = sender;
        this.receiver = receiver;
        this.entries = Collections
                .unmodifiableList(new ArrayList<GossipCacheEntry>(entries));
