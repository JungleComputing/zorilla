...
public final class Copy extends Job implements Receiver, Runnable {
    ...
    public Copy(JobAdvert advert, Node node) throws IOException,
            ZorillaException {
        if (!(advert instanceof PrimaryCopyAdvert)) {
            throw new ZorillaException("wrong advert type");
        }
        ...
        nameserverPort = ad.getNameserverPort();
        nameserverHost = ad.getNameserverHost();
