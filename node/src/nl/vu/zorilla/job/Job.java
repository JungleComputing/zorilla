...
public abstract class Job {
  ...
  public static final long DEFAULT_JOB_LIFETIME = 15 * 60 * 1000;
    ...
    public static Job create(URI executable, String[] arguments,
        ...
        if (executable == null) {
            throw new Exception("executable must be provided");
        }
        ...
        if (type == null || type.equalsIgnoreCase("primaryCopy")) {
            return new nl.vu.zorilla.job.primaryCopy.Primary(executable, arguments,
    ...
    public static Job createConstituent(Advert advert, Node node)
        ...
        if (type.equalsIgnoreCase("primaryCopy")) {
            return new nl.vu.zorilla.job.primaryCopy.Copy(advert, node);
        } else {
    ...
    protected static void checkAttributes(TypedProperties attributes)
        ...
        if (onUserExit != null
            ...
            throw new Exception("invalid value for on.user.exit: "
                    + onUserExit);
        }
     ...
     */
    public abstract Resources usedResources();
