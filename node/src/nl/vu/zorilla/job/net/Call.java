...
public final class Call implements ObjectInput, ObjectOutput {
    ...
    Call(ReceivePortIdentifier destination, PortType callType, PortType replyType) throws IOException {
        ...
        sendPort.connect(destination, CONNECTION_TIMEOUT);
    ...
    Call(IbisIdentifier ibis, String port, PortType callType, PortType replyType) throws IOException {
        id = Node.generateUUID();
        ...
        sendPort.connect(ibis, port, CONNECTION_TIMEOUT);
