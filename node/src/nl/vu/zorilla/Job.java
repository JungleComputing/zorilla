...
public abstract class Job {
     ...
     * @throws IOException
     */
    static Job createConstituent(ObjectInput in, Node node)
            throws ZorillaException, IOException {
        String type = in.readString();

        if (type.equalsIgnoreCase("primaryCopy")) {
            return new nl.vu.zorilla.primaryCopy.Copy(in, node);
        } else {
    ...
    /**
     * Writes a bootstrap of a job to the given output. Starts with writing a
     * String representing the Job type.
     */
    public abstract void writeBootstrap(ObjectOutput out) throws IOException;
