...
%JAVA_HOME%\bin\java -cp %CLASSPATH%;%ZORILLA_CLASSPATH% -Dlog4j.configuration=file:%ZORILLA_HOME%\log4j.properties -Dzorilla.home=%ZORILLA_HOME% nl.vu.zorilla.apps.Zee %*
