...
public class UdpCC {
	...
	try {
	    ...
	    sock.bind (new InetSocketAddress(my_addr.getPort()));
//        sock.bind (my_addr);
	...
	public void timer_cb (Object user_data) {
		...
		double ttfs = conn.time_to_first_send;
    ...
    protected static final int MAX_MSG_SIZE = 60*1024;
//protected static final int MAX_MSG_SIZE = 16*1024;
   ...
   protected final ByteBuffer alloc_bb (int sz) {
	...
	ByteBuffer bb = null;
        ...
        bb.putLong (ack);
        bb.putLong (seq);
        bb.putInt (0); // don't know how long it's been waiting
