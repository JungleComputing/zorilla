 ...
 * receiving node calls send responce with the token passed to the
 * request callback.  
 */
public class Rpc extends bamboo.util.StandardStage {
    ...
    public static class Msg implements QuickSerializable {
        public boolean req;
        public long xact_id;
    ...
    public Rpc () {
	inb_msg_types = new Class [] { Msg.class };
        next_xact_id = now_ms ();
    }
