...
public final class Zubmit {
    ...
    private static void addFile(String string, Map<String,String> inputs) throws Exception {
    ...
    public static void main(String[] command) {
        ...
        try {
            ...
            Map<String,String> preStage = new HashMap<String,String>();
            Map<String,String> postStage = new HashMap<String,String>();
